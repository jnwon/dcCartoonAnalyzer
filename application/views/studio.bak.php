...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="/AdminLTE-3.0.0-alpha.2/plugins/datatables/dataTables.bootstrap4.css">
  <!-- Theme style -->
  ...
  <!-- DataTables -->
  <script src="/AdminLTE-3.0.0-alpha.2/plugins/datatables/jquery.dataTables.js"></script>
  <script src="/AdminLTE-3.0.0-alpha.2/plugins/datatables/dataTables.bootstrap4.js"></script>
  <!-- SlimScroll -->
  ...
  <!-- AdminLTE App -->
  <script src="/AdminLTE-3.0.0-alpha.2/dist/js/adminlte.min.js"></script>
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      if(username.indexOf('로그인을 해 주시기 바랍니다.') >= 0) {
        alert('DC인사이드 로그인을 먼저 해주시기 바랍니다.');
        opener = self;
        window.close();
      }
      else{
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2018-2018 <a href="http://blog.naver.com/atalanta16" target="_blank">Spaghetti code</a> </strong>  
    All rights reserved.
